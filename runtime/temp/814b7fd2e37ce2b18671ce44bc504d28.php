<?php /*a:3:{s:73:"D:\phpstudy_pro\WWW\www.alaer.com\application\admin\view\issue\index.html";i:1569392550;s:75:"D:\phpstudy_pro\WWW\www.alaer.com\application\admin\view\layout\header.html";i:1569059483;s:75:"D:\phpstudy_pro\WWW\www.alaer.com\application\admin\view\layout\footer.html";i:1569388136;}*/ ?>
                ...
                <div class="example">
                    <table class="table table-bordered table-hover text-center">
                        ...
                        <tr class="long-td">
                            ...
                            <td>
                                <?php if($v['top']==1): ?>
                                <a href="javascript:;" onclick="top_issue(<?php echo htmlentities($v['id']); ?>)">
                                    <div id="zd<?php echo htmlentities($v['id']); ?>"><span class="label label-info">显示</span></div>
                                </a>
                                <?php else: ?>
                                <a href="javascript:;" onclick="top_issue(<?php echo htmlentities($v['id']); ?>)">
